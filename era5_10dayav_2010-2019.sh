...
#PBS -N era5_10dayav_2010_2019
#PBS -o /scratch/gb02/cc6171/logs/era5_10dayav_2010_2019.o
#PBS -e /scratch/gb02/cc6171/logs/era5_10dayav_2010_2019.e
...
TMPDIR="/scratch/gb02/cc6171/tmp_10dayav_2010_2019"
...
process_var() {
    ...
    local OUTDIR="${OUTBASE}/${OUTTYPE}/reanalysis/${VAR}/2019/10dayav_2010-2019"
    local OUTFILE="${OUTDIR}/${VAR}_era5_oper_${SUFFIX}_20191212.nc"
    mkdir -p "$OUTDIR"
